                      ...
                      <table id="datatable" class="table table-striped table-bordered " style="text-align: center">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="<?php echo $advertisement->adTitle;?>"><?php echo $advertisement->adTitle;?></a></td>
                            ...
                            <form action="process/advertisement.php" method="post" enctype="multipart/form-data">
                              <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="adTitle" id="adTitle" placeholder="Title For Ad" required="" >
                                </div>
                                <div class="form-group">
                                    <label for="">URL</label>
                                ...
                                <div class="form-group"  id="imgId">       
                                  <img src="<?php echo($thumbnail)?>" id="thumbnail" style="width: 300px; height: auto;" id="thumbnail" style="width: 300px; height: auto;">
                                </div>
                              </div>
...
<script type="text/javascript">
  ...
  function addAdvertisement(){
    ...
    var path = "<?php echo UPLOAD_URL?>noimage.png";
  ...
  function editAdvertisement(element){
    ...
    $('#adTitle').val(advertisement_info.adTitle);
    ...
    if (image_id!=''){
      ...
      var path = string.concat("<?php echo UPLOAD_URL?>",noimage.png);
    }
     $('#imgId img').attr("src",path); 
