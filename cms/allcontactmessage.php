                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                          ...
                          $contactmessages = $Contactmessage->getAllContactmessage();
                        ...
                        <tr>
                          ...
                          <td><?php echo $contactmessage->state;?></td>
                          <td>
                             <a href="process/contactmessage?id=<?php echo($contactmessage->id) ?>&amp;act=<?php echo substr(md5("Delete-Contactmessage-".$contactmessage->id.$_SESSION['token']), 3,15) ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this message?');">
