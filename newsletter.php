...
<div class="section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <h2 class="text text-success text-center">Sincere Thanks for subscribing us. we will send Newsletter soon.</h2>
            <br>
            <a href="index" >
            <button class="primary-button center-block " type="button">Home Page</button>
            </a>
            <br><br>
            </div>
    </div>
